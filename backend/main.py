...
from api.routers import core, analytics, predictions, supply, price_index, scenarios, events, graph, nl_query
...
app.include_router(nl_query.router, prefix='/api', tags=['nl-query'])
